...
<h4>🚀 Principais tecnologias:</h4>
  <img src="https://skillicons.dev/icons?i=bash,html,css,py,flask,mysql,grafana,git,github,gitlab,vscode,javascript,nodejs,typescript,md,obsidian&perline=10" />
</div>
